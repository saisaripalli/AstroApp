...
namespace AstroApp\Ganita\Method;

use AstroApp\Base\Data;
use AstroApp\Graha\Graha;
use AstroApp\Graha\Lagna;
use AstroApp\Ganita\Math;
use AstroApp\Ganita\Time;
...
class Swetest extends AbstractGanita {
    ...
    public function getParams(array $params = null, array $options = null) {
        ...
        $string = 'swetest' . $dir . $date . $time . $planets . $houses . $sid . ' -fPlbsad -g, -head';
        //echo '<br> In Swetest params :' . $string;
        putenv("PATH={$this->swe['swetest']}");
        //echo '<br> Current Dir :' . getcwd();
        //echo '<br>Path :' . $this->swe['swetest'];
        exec($string, $out);
        //echo '<br> Output from Swetest';
        //echo ' size of an array is: ' . count($out) . '<br>';
        /*
    ...
    private function formatParams($input, $params) {
        ...
        foreach ($input as $k => $v) {
            ...
            if (array_key_exists($bodyName, $this->outputPlanets)) {
                ...
                //echo ' outputPlanets ' . $dataParams[Data::BLOCK_GRAHA][$this->outputPlanets[$bodyName]]['longitude'] . '<br>';
                //echo 'rashi ' . $units['units'] . '<br>';
                //echo 'degree ' . $units['parts'] . '<br>';
                //echo ' ' . '<br>';
                ...
                //echo ' outputHouses ' . $dataParams[Data::BLOCK_BHAVA][$this->outputHouses[$bodyName]]['longitude'] . '<br>';
                //echo 'rashi ' . $units['units'] . '<br>';
                //echo 'degree ' . $units['parts'] . '<br>';
                //echo ' ' . '<br>';
                ...
                //echo ' outputLagna ' . $dataParams[Data::BLOCK_LAGNA][$this->outputLagna[$bodyName]]['longitude'] . '<br>';
                //echo 'rashi ' . $units['units'] . '<br>';
                //echo 'degree ' . $units['parts'] . '<br>';
                //echo ' ' . '<br>';
            }
        ...
        if (is_null($params) || in_array(Data::BLOCK_GRAHA, $params)) {
            ...
            //echo ' Hey ' . $dataParams['graha'][Graha::KEY_KE]['longitude'] . '<br>';
        }
