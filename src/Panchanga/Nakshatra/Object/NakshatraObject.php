 ...
 */
class NakshatraObject extends \AstroApp\Panchanga\AngaObject
{
    ...
    protected function setNakshatraStartEnd($options)
    {
        if ($options['withAbhijit']) {
            ...
            if ($this->nakshatraKey == 28) {
                throw new \AstroApp\Panchanga\Exception\InvalidArgumentException("Parameters of 28 nakshatra are determined only with argument 'withAbhijit' = true.");
            }
