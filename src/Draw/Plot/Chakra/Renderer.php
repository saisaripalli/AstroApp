...
namespace AstroApp\Draw\Plot\Chakra;

use AstroAppp\Graha\Graha;
use AstroApp\Rashi\Rashi;
use AstroApp\Base\Utility;
use AstroApp\Draw\Plot\Chakra\Style\AbstractChakra as Chakra;
...
class Renderer
{
     ...
     */
    public function drawChakra(\AstroApp\Base\Data $Data, $x, $y, array $options = null) {
        $this->setData($Data);
