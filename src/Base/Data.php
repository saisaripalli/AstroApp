...
use AstroApp\Graha\Upagraha;
use AstroApp\Bhava\Arudha;
use AstroApp\Ganita\Time;
use AstroApp\Ganita\Method\AbstractGanita as Ganita;
use AstroApp\Panchanga\AngaDefiner;
use AstroApp\Varga\Varga;
use AstroApp\Dasha\Dasha;
use AstroApp\Yoga\Yoga;
use AstroApp\Muhurta\Hora;
use DateTime;
...
class Data {
    ...
    public function calcDasha($type = Dasha::TYPE_VIMSHOTTARI, $periodKey = 'now', array $options = null) {
        ...
        //echo ' size of vimshottari data array: ' . count($this->data, COUNT_RECURSIVE) . '<br>';
        return $this;
    }
